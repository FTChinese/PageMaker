...
(function () {
    ...
    var dataRules = {
        ...
        float: [
          ...
          'HeadshotSquare',
          'ScoreBoard',
          'EqualSizeForNonFirstItems',
          'ItemsWithSameImage',
          'SplitList',
          'BiligualFullText',
          'Cover',
          'ItemsWithSameBigImage'
        ],
        showTag: [
          'no',
          'yes'
    ...
    var dataRulesTitle = {
        ...
        feedType: '自动抓取的内容类型；all抓取常规内容，translations抓取机器翻译内容，最新的先显示',
        ...
        feedTag: '自动抓取内容依据的标签；复杂条件可使用customFilter输入Mongo查询JSON',
    ...
    function renderAPI(obj) {
        ...
        if (obj.pubdate && obj.pubdate !== '') {
            obj.pubdate = unixtochinese(obj.pubdate, obj.timeStampType);
        }
